...
%\newcommand{\bvec}[1]{ \ifmmode\bm{#1}\else\textbf{#1}\fi }
...
% In case we need this next time to debug unicode stuff
...
\setboolean{display2_3_1}{true}

\setboolean{display3_1_1}{true}
\setboolean{display3_2_1}{true}
\setboolean{display3_3_1}{true}
...
\setboolean{display4_1_3}{true}

\setboolean{display4_3_0}{true}
\setboolean{display4_3_1}{true}
\setboolean{display4_3_2}{true}


\section{Introduction}
\ifthenelse{\boolean{display1}}{\subfile{sections/1--introduction}}{}

\section{ \tofix{Literature Review (To Do)}}
...
%    \subsubsection{Sequential Markov Chain Monte Carlo (SMCMC)}
    ...
    \subsection{Parameter Estimation}
    	...
    	\ifthenelse{\boolean{display2_3_1}}{\subfile{sections/2--3--1--inference-param-estimation}}{}
...
\section{Experimental Design}
	...
	\ifthenelse{\boolean{display3_2_1}}{\subfile{sections/3--2--1--experimental_real}}{}
	
	\subsection{Performance Metrics}\label{sec:experimental_performance}
	\ifthenelse{\boolean{display3_3_1}}{\subfile{sections/3--2--1--Performance Metrics}}{}
	
	\subsection{\tofix{Hyperparameter selection}} \label{sec:experimental_hyperparameter}
	
	\subsection{Trading Algorithm}
	\ifthenelse{\boolean{display3_5_1}}{\subfile{sections/3--5--1--Trading-Algorithm}}{}
...
\section{Experimental Results and Discussion}
    ...
    \ifthenelse{\boolean{display4_1_1}}{\subfile{sections/4--1--inference-comparison}}{}
    	...
    	\ifthenelse{\boolean{display4_1_3}}{\subfile{sections/4--1--3--adaotive-sampling-RBPF}}{}
    ...
    \ifthenelse{\boolean{display4_3_0}}{\subfile{sections/4--3--0--application_intro}}{}
    	
    	\subsubsection{Trading Performance}
    	\ifthenelse{\boolean{display4_3_1}}{\subfile{sections/4--3--1--trading-performance}}{}
    	
    	\subsubsection{\tofix{Time-scale exploration}}
    	\ifthenelse{\boolean{display4_3_0}}{\subfile{sections/4--3--0--application_intro}}{}
    
%    \subsection{Application to High Frequency Crytocurrency Trading}
